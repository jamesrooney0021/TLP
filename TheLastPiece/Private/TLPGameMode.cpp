...
#include "TLPGameMode.h"
#if WITH_GAMELIFT
#include "GameLiftServerSDK.h"
#endif

DEFINE_LOG_CATEGORY(Gamelift_SERVER)

ATLPGameMode::ATLPGameMode()
{
	InitGameliftServer();
}


void ATLPGameMode::InitGameliftServer()
{
#if WITH_GAMELIFT
	...
	UE_LOG(Gamelift_SERVER, Log, TEXT("GAME LIFT SERVER INITIALIZED"));
